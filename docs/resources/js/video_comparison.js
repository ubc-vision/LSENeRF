...
function playVids(videoId) {
    ...
    if (vid.readyState > 3) {
        ...
        function drawLoop() {
            ...
            mergeContext.drawImage(vid,
                colStart+vidWidth, 0, colWidth, vidHeight,
                colStart, 0, colWidth, vidHeight
            );            
            ...
            // Draw text overlay for baseline
            mergeContext.font = "40px Arial";
            mergeContext.fillStyle = "white";
            mergeContext.fillText("Our Method", 10, 50);   

            // Draw text overlay for our method
            mergeContext.font = "40px Arial";
            mergeContext.fillStyle = "white";
            const textWidth = mergeContext.measureText("BADNeRF [25]").width;
            const startX = vidWidth - textWidth - 10
            mergeContext.fillText("BADNeRF [25]", startX, 50);       
